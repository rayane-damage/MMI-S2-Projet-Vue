    ...
    <section v-if="isActive === true" class="bg-mainBlue h-screen flex flex-col gap-6">
        <div v-show="compteMode === 'none'" class="flex flex-col gap-4">
            ...
            <SettingsLegalCard @pointerdown="sectionOpen =  sectionOpen === 5 ? 0:5"
                                ...
                                text="To-Gather à été crée dans le but de permettre aux utilisateurs de pouvoir se remémorer des souvenirs joyeux et de passer de meilleurs jours en se les remémorant.
                                To-Gather vous permet aussi de discuter avec vos proches en leur partageant vos memories et donc de sourire ensemble."
                                :number="5"/>
